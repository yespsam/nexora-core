...
每个伙伴包含原生 GLB 模型，以及待机、亲近、点头、招手、说话、行走和跑步动作。动作片段在同一骨骼上缓存并平滑切换，三只伙伴也分别拥有独立的对话性格和声线。项链网页只显示 3D 角色，不再提供 2D 造型切换。

当前共鸣成长会改变人格参数和阶段名称；九套独立 3D 进化形态仍在制作计划中，尚未作为已完成功能展示。
