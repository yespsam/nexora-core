...
test('desktop bridge downloads stay pinned to the private internal release', () => {
  assert.equal(DESKTOP_BRIDGE_RELEASE_TAG, 'bridge-v0.1.0-internal');
  ...
  for (const download of Object.values(DESKTOP_BRIDGE_DOWNLOADS)) {
    assert.match(download.href, /^https:\/\/github\.com\/yespsam\/nexora-core\/releases\/download\/bridge-v0\.1\.0-internal\//);
